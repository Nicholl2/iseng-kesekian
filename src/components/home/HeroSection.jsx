...
import { LucideHamburger, Play, ArrowRight, Hamburger } from 'lucide-react';
    ...
    <section className="relative overflow-hidden min-h-screen md:min-h-[85vh] flex items-center">
      ...
      <div className="md:hidden relative z-10 w-full px-4 py-8 text-center">
        <div className="mb-4">
          ...
          <p className="text-slate-600 text-base mb-4 mt-4">Amel Kale Kaya Bakaran</p>
          <p className="text-slate-500 text-sm max-w-xs mx-auto leading-relaxed">
             Temukan masakan yang menggugah selera di Pemalang.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-10">
              ...
              <p className="text-2xl text-slate-600 mb-8">Amel Kale Kaya Bakaran</p>
